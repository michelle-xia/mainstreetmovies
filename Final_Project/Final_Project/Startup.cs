...
namespace Final_Project
{
    public class Startup
    {
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            String connectionString = "Server=tcp:fa20team19finalproject.database.windows.net,1433;Initial Catalog=fa20team19finalproject;Persist Security Info=False;User ID=MISAdmin;Password=Password1;MultipleActiveResultSets=True;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
